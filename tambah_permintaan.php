  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Form Penambahan Permintaan</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
		...
		<div class="card card-info">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="dasar_permintaan">
					</div>
				</div>
				<div class="form-group">
				...
				<div>
					<button type="submit" class="btn btn-info" style="background-color: #17a2b8" name="submit">Tambah</button>
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					mysqli_query($koneksi, "INSERT INTO permintaan VALUES('','$user','$dasar_permintaan','$ket')");
