...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<?php
		include 'koneksi.php';
		$data = mysqli_query($koneksi, "SELECT * FROM pembayaran WHERE no='".$_GET['no']."'");
		...
		<div class="card card-info">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="no_kuitansi" value="<?php echo $col['no_kuitansi']; ?>">
					</div>
				</div>
				<div>
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					mysqli_query($koneksi, "UPDATE pembayaran SET no_kuitansi='$no_kuitansi' WHERE no='$no'");
