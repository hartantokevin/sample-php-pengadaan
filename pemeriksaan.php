  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Kontrak</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
			...
			<div class="card-body">
				<table class="table table-bordered table-striped">
					...
					<?php
						...
						{
							$bool = false;
							$data2 = mysqli_query($koneksi, "SELECT * FROM pemeriksaan");
							...
							if(!$bool)
							{
								...
								echo "<td class='align-middle' style='text-align:left; border-right:0'>Rp.</td>";
								echo "<td class='align-middle' style='text-align:right; border-left:0'>".$str.",-</td>";
								echo "<td class='align-middle'>".$d['penyedia']."</td>";
								$tgl_mulai = date_create($d['tgl_mulai']);
								echo "<td class='align-middle'>".date_format($tgl_mulai,"d F Y")."</td>";
								$tgl_selesai = date_create($d['tgl_selesai']);
								echo "<td class='align-middle'>".date_format($tgl_selesai,"d F Y")."</td>";
								if($_SESSION['akses'] == "admin")
									echo "<td class='align-middle'><a href='edit_kontrak.php?no=".$d['no']."' style='color:white'><button class='btn btn-info'><i class='fas fa-edit'></i> Edit</a></button>
									<a href='tambah_pemeriksaan.php?no=".$d['no']."' style='color:white'><button class='btn btn-primary'><i class='fas fa-folder'></i> Input Pemeriksaan</a></button></td>";
								echo "</tr>";
							}
						}
					?>
