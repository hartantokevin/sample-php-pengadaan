  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Kontrak dan Pemeriksaan</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
		...
		<div class="card card-info">
			...
			<div class="card-body">
				<table class="table table-bordered table-striped">
					...
					<?php
						include 'koneksi.php';
						$data = mysqli_query($koneksi, "SELECT * FROM pemeriksaan JOIN kontrak WHERE pemeriksaan.no=kontrak.no");
						while($d = mysqli_fetch_array($data))
						{
							$bool = false;
							$data2 = mysqli_query($koneksi, "SELECT * FROM pembayaran");
							...
							if(!$bool)
							{
								...
								echo "<td class='align-middle'>".$d['no_bapp']."</td>";
								if($_SESSION['akses'] == "admin")
									echo "<td class='align-middle'><a href='edit_pemeriksaan.php?no=".$d['no']."' style='color:white'><button class='btn btn-info'><i class='fas fa-edit'></i> Edit</a></button>
									<a href='tambah_pembayaran.php?no=".$d['no']."' style='color:white'><button class='btn btn-primary'><i class='fas fa-folder'></i> Input Pembayaran</a></button></td>";
								echo "</tr>";
							}
						}
					?>
