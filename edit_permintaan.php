...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="permintaan.php" class="nav-link active">
  ...
  <div class="content-wrapper">
	...
	<?php
		include 'koneksi.php';
		$data = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE no='".$_GET['no']."'");
      ...
      <div class="container-fluid">
		<div class="card card-info">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<?php
							...
							{
								if($user['user'] == $col['user'])
									echo '<option selected>'.$user['user'].'</option>';
								else
				...
				<div class="form-group">
					<label>Dasar Permintaan</label>
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-sticky-note"></i></span>
						</div>
						<input type="text" class="form-control" name="dasar_permintaan" value="<?php echo $col['dasar_permintaan']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="ket" value="<?php echo $col['ket']; ?>">
					</div>
				</div>
				<div>
					<button type="submit" class="btn btn-info" style="background-color: #17a2b8" name="submit">Update</button>
					<button class="btn btn-default"><a href="permintaan.php">Batal</a></button>
                </div>
			</div>
			</form>
			<?php
				if(isset($_POST['submit']))
				{
					...
					$no = $_POST['no'];
					$user = $_POST['user'];
					$dasar_permintaan = $_POST['dasar_permintaan'];
					$ket = $_POST['ket'];
					
					mysqli_query($koneksi, "UPDATE permintaan SET user='$user', dasar_permintaan='$dasar_permintaan', ket='$ket' WHERE no='$no'");
					echo "<script>window.location = 'permintaan.php';</script>";
				}
			?>
		</div>
      </div><!-- /.container-fluid -->
