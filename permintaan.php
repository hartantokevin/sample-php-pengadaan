      ...
      <div class="container-fluid">
		...
		<?php
			if($_SESSION['akses'] == "admin")
				echo '<button class="btn btn-info"><a href="tambah_permintaan.php" style="color:white">Tambah Permintaan</a></button>';
		?>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
				...
				<table class="table table-bordered table-striped">
					...
					<?php
						...
						while($d = mysqli_fetch_array($data))
						{
							...
							if($_SESSION['akses'] == "admin")
								echo "<td class='align-middle'><a href='edit_permintaan.php?no=".$d['no']."' style='color:white'><button class='btn btn-info'><i class='fas fa-edit'></i> Edit</a></button>
								<a href='hapus_permintaan.php?no=".$d['no']."' style='color:white'><button class='btn btn-danger'><i class='fas fa-trash'></i> Hapus</a></button></td>";
							echo "</tr>";
