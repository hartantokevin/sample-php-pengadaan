      ...
      <nav class="mt-2">
		...
		<li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="kontrak.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Paket</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
			...
			<div class="card-body">
				<table class="table table-bordered table-striped">
					...
					<?php
						...
						{
							$bool = false;
							$data2 = mysqli_query($koneksi, "SELECT * FROM kontrak");
							...
							if(!$bool)
							{
								...
								echo "<td class='align-middle'>".$d['akun']."</td>";
								...
								if($_SESSION['akses'] == "admin")
									echo "<td class='align-middle'><a href='edit_paket.php?no=".$d['no']."' style='color:white'><button class='btn btn-info'><i class='fas fa-edit'></i> Edit</a></button>
									<a href='tambah_kontrak.php?no=".$d['no']."' style='color:white'><button class='btn btn-primary'><i class='fas fa-folder'></i> Input Kontrak</a></button></td>";
								echo "</tr>";
							}
						}
					?>
