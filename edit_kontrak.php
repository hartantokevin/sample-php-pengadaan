...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pemeriksaan.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
	...
	<?php
		include 'koneksi.php';
		$data = mysqli_query($koneksi, "SELECT * FROM kontrak WHERE no='".$_GET['no']."'");
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="no_kontrak" value="<?php echo $col['no_kontrak']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="nilai_kontrak" value="<?php echo $col['nilai_kontrak']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="penyedia" value="<?php echo $col['penyedia']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" name="tgl_mulai" value="<?php echo $col['tgl_mulai']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" name="tgl_selesai" value="<?php echo $col['tgl_selesai']; ?>">
					</div>
				</div>
				<div>
					<button type="submit" class="btn btn-info" style="background-color: #17a2b8" name="submit">Update</button>
					<button class="btn btn-default"><a href="pemeriksaan.php">Batal</a></button>
                </div>
			</div>
			</form>
			<?php
				if(isset($_POST['submit']))
				{
					...
					mysqli_query($koneksi, "UPDATE kontrak SET no_kontrak='$no_kontrak', nilai_kontrak='$nilai_kontrak', penyedia='$penyedia', tgl_mulai='$tgl_mulai', tgl_selesai='$tgl_selesai' WHERE no='$no'");
				}
			?>
		</div>
      </div><!-- /.container-fluid -->
