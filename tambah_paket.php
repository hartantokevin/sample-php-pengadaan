		...
		<div class="card card-info">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<label class="form-control"><?php echo $_GET['no']; ?></label>
						<input type="hidden" name="no_paket" value="<?php echo $_GET['no']; ?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="nilai_hps">
					</div>
				</div>
				<div>
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					mysqli_query($koneksi, "INSERT INTO paket VALUES('$no_paket','$nama_paket','$akun','$nilai_hps')");
